...
function Header({ sidebarOpen, toggleSidebar, setActivePage }) {
    return (
        <div className="fixed top-0 left-0 right-0 h-[60px] bg-[var(--bg-surface)] z-[100] flex items-center px-4 py-2 border-b-2 border-[rgba(159,92,255,0.3)] shadow-[0_4px_40px_rgba(159,92,255,0.2)]
